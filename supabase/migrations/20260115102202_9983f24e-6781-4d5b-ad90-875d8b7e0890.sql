-- Update reward calculation formula
-- NEW: Posts=10,000, Reactions=1,000, Comments=2,000, Shares=10,000, Friends=10,000
-- REMOVED: 10,000 new user bonus, 3+ reactions threshold
